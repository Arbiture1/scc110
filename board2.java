import javax.swing.*;
import java.awt.*;
import java.awt.Image; // includes relavant files to give me access to a full range of tools
import java.util.*; // includes relavant files to give me access to a full range of tools
import java.awt.event.*; // includes relavant files to give me access to a full range of tools



public class Board     // Creates a class called Board 
{
  public Board()    // an instance of the class board that allows the panel and window to be used together
  {
 ...
 public static void main (String args[])    // This method is exucutd first when Board is run 
  {
    JPanel panel = new JPanel();     // Creates an instance of jpanel called panel inside of Board 
    JFrame  window = new JFrame ();     //Creates an instance of JFrame called  window insode of board
    Square [] Pattern = new Square[100]; // creates an array of squares and calls it pattern  
    GridLayout Gridzy_Boi= new GridLayout(8,8);   // gives the  array a grid layout of 8,8 
